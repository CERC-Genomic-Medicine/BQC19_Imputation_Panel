...
def calculates_stats(input_file, path_out):
    ...
    result_dict = {'NC':[frequence['c']], 'ND': [frequence['d']], 'NO': [frequence['o']], 'NM': [frequence['m']], 'PC':[pct_concordant], 'PM':[pct_missing], 'PO':[pct_only_imputed]}
