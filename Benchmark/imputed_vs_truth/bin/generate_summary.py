...
def calculates_stats(sample_ID, input_file, path_out):
    ...
    result_dict = {'Sample ID':[sample_ID], 'WGS':[WGS_AND_REF_EQ + WGS_AND_REF_GT + WGS_AND_REF_LT + WGS], 'REF': [Only_REF], 'WGS_AND_REF' : [WGS_AND_REF_EQ + WGS_AND_REF_LT + WGS_AND_REF_GT],\
     'WGS_AND_REF_EQ': [WGS_AND_REF_EQ], 'WGS_AND_REF_LT':[WGS_AND_REF_LT], 'WGS_AND_REF_GT':[WGS_AND_REF_GT],\
     'REF_0ALT' : [Only_REF_0ALT], 'WGS_0ALT':[Only_WGS_0ALT + WGS_0ALT_AND_REF_EQ + WGS_0ALT_AND_REF_LT]}
